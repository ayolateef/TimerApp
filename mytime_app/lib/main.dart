...
class TimerHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   Expanded(
    child: ProductivityButton(size: 20.0, color: Color(0xff009688),
    text: "Work",
    onPressed: () => timer.startWork())),

    Padding(padding: EdgeInsets.all(defaultPadding),),
    Expanded(
      child: ProductivityButton(size: 20.0, color: Color(0xff607D8B),
    text: "Short Break", onPressed: () => timer.startBreak(true))),
    Padding(padding: EdgeInsets.all(defaultPadding),),
    Expanded(
    child: ProductivityButton(size: 20.0, color: Color(0xff455A64),
    ...
    Padding(padding: EdgeInsets.all(defaultPadding),),
    Expanded(
    child: ProductivityButton(size: 20.0, color: Color(0xff212121),
